...
function LoginPage() {
    ...
    async function handleSubmit(e) {
        ...
        setError("");
        setLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$players$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginPlayer"])(form);
        setLoading(false);
        if (!result.ok) {
            setError(result.error);
            return;
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setSession"])({
            id: result.player.id,
...
//# sourceMappingURL=_0g_0tpx._.js.map