...
(()=>{
    const e = new Error("Cannot find module '@/components/RequestsPanel'");
...
function DashboardPage() {
    ...
    function handleCancelRequest(player) {
        setMyRequest(null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$requests$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cancelPresenceRequest"])(player.id).catch((err)=>setPlayersError(err.message));
    }
    function handleApproveRequest(request) {
        setRequests((prev)=>prev.filter((r)=>r.id !== request.id));
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$requests$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolvePresenceRequest"])(request.id).catch((err)=>setPlayersError(err.message));
    ...
    function handleDenyRequest(requestId) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$requests$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolvePresenceRequest"])(requestId).catch((err)=>setPlayersError(err.message));
    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            ...
            if (isAdmin) {
                let cancelled = false;
                const refresh = {
                    "DashboardPage.useEffect.refresh": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$requests$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllPresenceRequests"])().then({
                ...
                refresh();
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$requests$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeToAllPresenceRequests"])(refresh);
                return ({
                    "DashboardPage.useEffect": ()=>{
                        cancelled = true;
                        unsubscribe();
            ...
            if (currentPlayerId) {
                let cancelled = false;
                const refresh = {
                    "DashboardPage.useEffect.refresh": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$requests$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOwnPresenceRequest"])(currentPlayerId).then({
                            "DashboardPage.useEffect.refresh": (data)=>{
                ...
                refresh();
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$requests$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeToOwnPresenceRequest"])(currentPlayerId, refresh);
                return ({
                    "DashboardPage.useEffect": ()=>{
                        cancelled = true;
                        unsubscribe();
                ...
                children: [
                    ...
                    isAdmin && sidebarOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RequestsPanel, {
                                requests: requests,
                    ...
                    !isAdmin && currentPlayer && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PlayerPanel, {
...
_s(DashboardPage, "m78tHdZoF3PMDqrxLaoPiLRURzA=", false, function() {
    return [
...
//# sourceMappingURL=_1h8g-pd._.js.map