...
function DashboardPage() {
    ...
    const pendingQueueWrites = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const pendingDurationWrite = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    ...
    function persistQueues(updater) {
        setQueues((prev)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveQueues"])(next).catch((err)=>setPlayersError(err.message)).finally(()=>{
                pendingQueueWrites.current--;
            });
            return next;
        });
    ...
    function handleQueuePlayer(player) {
        persistQueues((prevQueues)=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tiers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assignPresentPlayer"])(player, prevQueues, players, newQueueId);
        });
    }
    ...
    function handleApproveRequest(request) {
        ...
        if (request.type !== "team_create" && request.type !== "team_join") {
            persistQueues((prevQueues)=>{
                if (isPlayerQueuedOrPlaying(player.id, prevQueues)) return prevQueues;
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$tiers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assignPresentPlayer"])(updatedPlayer, prevQueues, updatedPlayers, newQueueId);
            });
        }
    }
    ...
    function handleDurationChange(minutes, manual = true) {
        ...
        const save = manual ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveDurationManual"])(minutes) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveDuration"])(minutes);
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                onClick: ()=>{
                                                                    ...
                                                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveAutoDuration"])(true).catch((err)=>setPlayersError(err.message));
                                                                },
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                onClick: ()=>{
                                                                    ...
                                                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveAutoDuration"])(false).catch((err)=>setPlayersError(err.message));
                                                                },
...
_s(DashboardPage, "xqPmFFIOQJQxvCPKDACSk6LRWZA=", false, function() {
    return [
...
async function getAppState() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("app_state").select("courts, queues, duration, announcement, auto_duration").eq("id", STATE_ROW_ID).single();
    if (error) throw new Error(error.message);
    return data;
}
