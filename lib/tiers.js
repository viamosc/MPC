...
export function buildAutoQueues(players, skillBased = true) {
  if (!skillBased) {
    const groups = [];
...
export function assignPlayerToQueues(player, queues, makeId, skillBased = true) {
...
export function assignPresentPlayer(player, queues, allPlayers, makeId, skillBased = true) {
  if (player.team_id) {
